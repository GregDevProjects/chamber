...
const drawBackground = scene => {
  ...
  scene.graphics.lineStyle(2, 0x000000, 1);

  scene.graphics.fillStyle(0x989898, 1);

  const framePadding = 150;

  scene.graphics.fillRect(0, 0, FRAME_WIDTH, framePadding);

  scene.graphics.fillRect(0, 0, framePadding, FRAME_HEIGHT);
  ...
  scene.graphics.strokeRect(0, 0, FRAME_WIDTH, FRAME_HEIGHT);
